...
--
-- Name: shouts_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE shouts_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: shouts_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE shouts_id_seq OWNED BY shouts.id;
...
ALTER TABLE ONLY shouts ALTER COLUMN id SET DEFAULT nextval('shouts_id_seq'::regclass);
...
--
-- Name: shouts_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY shouts
    ADD CONSTRAINT shouts_pkey PRIMARY KEY (id);
...
--
-- Name: index_shouts_on_user_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_shouts_on_user_id ON shouts USING btree (user_id);


--
-- Name: fk_rails_2461cde3a9; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY shouts
    ADD CONSTRAINT fk_rails_2461cde3a9 FOREIGN KEY (user_id) REFERENCES users(id);
